...
export default function Page() { return (<Shell><Head><title>visual identity | Workeaser</title></Head>
  <div className="flex items-center justify-between mb-6"><h1 className="text-[24px] font-bold text-[#2B3450]">visual identity</h1></div>
