...
export default function Page() { return (<Shell><Head><title>Bookings | Workeaser</title></Head>
  <h1 className="text-[24px] font-bold text-[#2B3450] mb-6">Bookings</h1>
  <div className="bg-surface border border-border rounded-lg p-12 text-center text-outline text-[13px]">Bookings — read-only from existing data. Full functionality pending future block.</div>
</Shell>); }
