...
function ClientModal({ client, onClose }: { client?: any; onClose: () => void }) {
  ...
  return (<div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center" onClick={onClose}>
    <div className="bg-surface rounded-xl shadow-2xl max-w-3xl w-full max-sm:w-full mx-4 max-sm:mx-0 max-h-[90vh] max-sm:h-full max-sm:max-h-none max-sm:rounded-none overflow-y-auto" onClick={e=>e.stopPropagation()}>
