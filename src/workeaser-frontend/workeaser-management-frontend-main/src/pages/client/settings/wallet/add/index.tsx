...
import {
  BankButtonContainer,
  ButtonContainer,
} from "@styles/pages/settings/waller/add";
...
const AddWallet = ({ payment_method, initialData }: AddWallterProps) => {
  ...
  const handleSubmit: SubmitHandler<FormData> = async (data) => {
    try {
      ...
      if (payment_method === "CARD") {
        ...
        mutate("/wallet");
        router.push("/client/settings/wallet");
      } else {
  ...
  const options = {
    style: {
      ...
      invalid: {
        iconColor: theme.colors.notifyFail,
        color: theme.colors.notifyFail,
      },
    },
  };
