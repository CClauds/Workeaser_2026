...
export const ClientProfilePopup: React.FC<ProfilePopupProps> = ({ isOpen }) => {
  ...
  return (
    <Container isOpen={isOpen}>
        ...
        <div>
          ...
          <section>
            <DoublelineCell
              ...
              subtitle={user?.clientAccount?.company_name}
            />
          </section>
        </div>
      </Header>
      ...
      <AssetsContainer>
        <div>
          <p>Active Assets:</p>
          <StatusContainer bgColor="green">0</StatusContainer>
          <p>Day Passes</p>
          <StatusContainer bgColor="green">0</StatusContainer>
          <p>Meeting Discount</p>
        </div>
      </AssetsContainer>
