...
import { InvoiceFilters } from "pages/finances/invoices";
...
const DOCUMENT_STATUS: { name: string; slug: string }[] = [
  {
    name: "Invoice Sent",
    slug: "docStatusSent",
  },
  {
    name: "Viewed by the Customer",
    slug: "docStatusViewed",
  },
  {
    name: "Partially Paid or Fully",
    slug: "docStatusPaid",
  },
  {
    name: "Payment Deposited",
    slug: "docStatusDeposit",
  },
];
