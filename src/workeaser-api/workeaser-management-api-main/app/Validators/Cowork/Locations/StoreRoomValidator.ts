...
import { ContractTermEnum, MeasurementTypeEnum } from 'Contracts/enums';

export default class StoreRoomValidator {
  ...
  public schema = schema.create({
    ...
    space_size_unit: schema.enum([MeasurementTypeEnum.FEETS, MeasurementTypeEnum.METERS] as const),
    space_size: schema.number([rules.unsigned()]),
    renewal_tax: schema.number.optional([rules.unsigned()]),
    room_capacity: schema.number([rules.unsigned()]),
